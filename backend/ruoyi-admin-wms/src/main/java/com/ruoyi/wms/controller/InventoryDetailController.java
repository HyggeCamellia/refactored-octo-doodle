...
public class InventoryDetailController extends BaseController {
     ...
     */
    @GetMapping(value = "/{id}")
    public R<InventoryDetailVo> getInfo(@PathVariable("id") Long id) {
    ...
    @RepeatSubmit()
    @PostMapping
    public R<Void> add(@Validated @RequestBody InventoryDetailBo bo) {
    ...
    @RepeatSubmit()
    @PutMapping
    public R<Void> edit(@Validated @RequestBody InventoryDetailBo bo) {
